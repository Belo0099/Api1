...
function MyLibrary:MakeWindow(Configs)
	...
	-- ═══════════════════════════════════════════════
	--     SIDEBAR COM PROFILE (DO PRIMEIRO CÓDIGO)
	-- ═══════════════════════════════════════════════
	...
	local function ControlSize()
		...
		Sidebar.Size = UDim2.new(0, ControlSize2.Position.X.Offset, 1, 0)
		ContentContainer.Size = UDim2.new(1, -(ControlSize2.Position.X.Offset + 10), 1, -20)
		ContentContainer.Position = UDim2.new(0, ControlSize2.Position.X.Offset + 5, 0, 10)
	...
	local ButtonsFolder = Create("Folder", ProfileFrame, {
		Name = "Buttons"
	})
	...
	task.delay(0.1, function()
		...
		if firstTab then
			firstTab:FindFirstChildOfClass("TextLabel").TextColor3 = Color3.fromRGB(255, 255, 255)
			firstTab.BackgroundColor3 = Theme["Color Theme"]
			local img = firstTab:FindFirstChildOfClass("ImageLabel")
